...
pub union BitwuzlaOptionInfo__bindgen_ty_1 {
    pub numeric: BitwuzlaOptionInfo__bindgen_ty_1__bindgen_ty_1,
    pub string: BitwuzlaOptionInfo__bindgen_ty_1__bindgen_ty_2,
}
#[repr(C)]
...
fn bindgen_test_layout_BitwuzlaOptionInfo__bindgen_ty_1__bindgen_ty_1() {
    const UNINIT: ::std::mem::MaybeUninit<BitwuzlaOptionInfo__bindgen_ty_1__bindgen_ty_1> =
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).cur_val) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(BitwuzlaOptionInfo__bindgen_ty_1__bindgen_ty_1),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).def_val) as usize - ptr as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(BitwuzlaOptionInfo__bindgen_ty_1__bindgen_ty_1),
...
fn bindgen_test_layout_BitwuzlaOptionInfo__bindgen_ty_1__bindgen_ty_2() {
    const UNINIT: ::std::mem::MaybeUninit<BitwuzlaOptionInfo__bindgen_ty_1__bindgen_ty_2> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
extern "C" {
    pub fn bitwuzla_sort_hash(sort: *const BitwuzlaSort) -> usize;
}
extern "C" {
...
extern "C" {
    pub fn bitwuzla_term_hash(term: *const BitwuzlaTerm) -> usize;
}
extern "C" {
...
extern "C" {
    pub fn bitwuzla_term_get_indices(term: *const BitwuzlaTerm, size: *mut usize) -> *mut u32;
}
extern "C" {
